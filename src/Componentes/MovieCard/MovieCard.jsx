...
export function MovieCard (props) {
    ...
    return (
        <div className="rounded-3xl shadow-lg p-4 text-xl flex border-2 border-gray-100 items-center sm:h-48 sm:w-96 h-44 w-80">
            ...
            <div className="p-4">
                <h1 className="sm:text-2xl font-bold text-xl pb-2">{title}</h1>
                <h1 className="text-sm sm:text-base"><span className="font-semibold">Popularidad:</span>&nbsp;{popularity}</h1>
                <h1 className="text-sm sm:text-base"><span className="font-semibold">Idioma:</span>&nbsp;
